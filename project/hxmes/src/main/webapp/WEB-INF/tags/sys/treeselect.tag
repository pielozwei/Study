...
<div class="input-append">
	<input type="hidden" id="${id}Id" name="${name}" class="${cssClass}" value="${value}"/>
	<input type="text" id="${id}Name" name="${labelName}" ${allowInput?'':'readonly="readonly"'}  
		value="${labelValue}" data-msg-required="${dataMsgRequired}" class="${cssClass} ${required }" style="${cssStyle}"/>
