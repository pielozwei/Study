...
<script src="${ctxStatic}/common/js/exportTable.js" type="text/javascript"></script>
<script src="${ctxStatic}/common/js/commonintegrationfunc.js" type="text/javascript"></script>
