...
<head>
	...
	$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${gylxList}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.pid?tpl.pid:0}', name:"${tpl.name}", 
		            	url:"${ctx}/ip/technique/editform?id=${tpl.id}", target:"techniqueMainFrame"},
		            </c:forEach>];
...
<body>
	<div class="accordion-group">
	    ...
	    <div class="accordion-heading">
	    	<a class="accordion-toggle">工艺路线列表</a>
	    </div>
