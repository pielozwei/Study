	...
	<script type="text/javascript">
		...
		function search(){
			...
			if(sign == 'jumpQczbyPage'){
				window.location.href = '${ctx}/quality/zjWttzd/jumpWcqktbzlyPage?'+search;
			}else if(sign == 'getCompleteTask'){
				window.location.href = '${ctx}/quality/zjWttzd/getCompleteTaskWcqktbzly?'+search;
			}
		}
	</script>
</head>
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/quality/zjWttzd/jumpWcqktbzlyPage">历史任务</a></li>
		<li><a href="${ctx}/quality/zjWttzd/getCompleteTaskWcqktbzly">待处理任务</a></li>
	</ul>
		...
		<c:forEach items="${page.list}" var="zjWttzd">
			<tr>
				...
				<shiro:hasPermission name="quality:zjWttzd:edit"><td>
					<a href="${ctx}/quality/zjWttzd/wcqktbzlyForm?id=${zjWttzd.id}&identity=wcqktb">完成情况填报</a>
