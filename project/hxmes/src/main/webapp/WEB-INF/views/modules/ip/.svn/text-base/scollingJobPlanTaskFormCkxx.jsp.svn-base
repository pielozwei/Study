		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules : {
					...
					"task.gzrwmc" : {
						remote : "${ctx}/ip/scollingJobPlanTask/checkName?oldName=" + ""
					}
				},
				messages : {
					"task.wcqx" : {
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="javascript:void(0);">引用参考消息到任务</a></li>
		<li class="pull-right">
	...
	<form:form id="inputForm" modelAttribute="scollingJobPlanTask" action="${ctx}/ip/scollingJobPlanTask/save?referenceMessageId=${referenceMessageId}" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input id="wcqx" onblur="setJhwcsj()" onchange="setJhwcsj()" oninput="setJhwcsj()" onpropertychange="setJhwcsj()" path="task.wcqx" htmlEscape="false" maxlength="20" class="required digits"/>天
			</div>
		</div>
		<div class="control-group">
