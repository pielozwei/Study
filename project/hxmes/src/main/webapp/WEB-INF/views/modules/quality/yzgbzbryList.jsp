	...
	<script type="text/javascript">
		...
		function search(){
			...
			if(sign == 'jumpQczbyPage'){
				window.location.href = '${ctx}/quality/zjWttzd/jumpYzgbzbryPage?'+search;
			}else if(sign == 'getCompleteTask'){
				window.location.href = '${ctx}/quality/zjWttzd/getCompleteTaskYzgbzbry?'+search;
			}
		}
	</script>
</head>
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/quality/zjWttzd/jumpYzgbzbryPage">历史任务</a></li>
		<li><a href="${ctx}/quality/zjWttzd/getCompleteTaskYzgbzbry">待处理任务</a></li>
	</ul>
		...
		<c:forEach items="${page.list}" var="zjWttzd">
			<tr>
				...
				<shiro:hasPermission name="quality:zjWttzd:edit"><td>
					<a href="${ctx}/quality/zjWttzd/yzgbzbryForm?id=${zjWttzd.id}&identity=yzgb">验证关闭</a>
