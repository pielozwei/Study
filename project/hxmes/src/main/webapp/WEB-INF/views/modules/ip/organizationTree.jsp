...
<head>
	...
	$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${organizationList}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.id?tpl.id:0}', name:"${tpl.name}", 
		            	url:"${ctx}/ip/organizationDepartment/list?organization.id=${tpl.id}", target:"organizationMainFrame"},
		            </c:forEach>];
...
<body>
	<div class="accordion-group">
	    ...
	    <div class="accordion-heading">
	    	<a class="accordion-toggle">组织列表</a>
	    </div>
