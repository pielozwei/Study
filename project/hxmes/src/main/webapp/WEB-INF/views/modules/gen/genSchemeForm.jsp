...
<body>
	...
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select id="category" path="category" class="input-xlarge"><form:option value="" label=""/>
					<form:options items="${fns:getDictList('gen_category')}" itemValue="value" itemLabel="label" htmlEscape="false"/>
				</form:select>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="genTableId" class="required input-xlarge">
