...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			var zNodes=[
		            <c:forEach items="${ckList}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.sjjd?tpl.sjjd.id:0}', name:"${tpl.mc}",
		            	url:"${ctx}/cangku/${not empty module?module:'none'}/list?${module=='ckbmd'?'ipCkCkbh':(module=='ckhmd'?'ipCkCkbh':'id')}=${tpl.id}", target:"cangkuMainFrame"},
		            </c:forEach>];
...
<body>
	<div class="accordion-group">
	    <div class="accordion-heading">
	    	<a class="accordion-toggle">仓库层次列表</a>
	    </div>
