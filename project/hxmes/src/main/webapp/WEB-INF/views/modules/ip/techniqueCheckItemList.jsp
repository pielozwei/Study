...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/ip/techniqueCheckItem/">质量检测项列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="techniqueCheckItem"
		...
		<input id="pageSize" name="pageSize" type="hidden"
			value="${page.pageSize}" />
		<label>工序 ：</label>
		<tags:treeselect id="gylx_id" name="technique.id" value="${list.id}"
		...
		<tbody>
			<c:forEach items="${page.list}" var="techniqueCheckItem">
				<tr>
					...
					<td class="xl"></td>
					<td>${techniqueCheckItem.technique.mc}</td>
