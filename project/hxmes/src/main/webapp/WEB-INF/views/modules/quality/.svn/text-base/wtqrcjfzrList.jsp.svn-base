	...
	<script type="text/javascript">
		...
		function search(){
			...
			if(sign == 'jumpQczbyPage'){
				window.location.href = '${ctx}/quality/zjWttzd/jumpWtqrcjfzrPage?'+search;
			}else if(sign == 'getCompleteTask'){
				window.location.href = '${ctx}/quality/zjWttzd/getCompleteTaskWtqrcjfzr?'+search;
			}
		}
	</script>
</head>
		...
		<c:forEach items="${page.list}" var="zjWttzd">
			<tr>
				...
				<shiro:hasPermission name="quality:zjWttzd:edit"><td>
					<a href="${ctx}/quality/zjWttzd/wtqrcjfzrForm?id=${zjWttzd.id}&identity=wtqr">问题确认</a>
