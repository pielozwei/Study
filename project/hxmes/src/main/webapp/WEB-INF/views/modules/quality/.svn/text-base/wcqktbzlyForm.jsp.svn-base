...
<head>
	...
	<script type="text/javascript">
		...
		function tbwc(){
			...
			window.location.href="${ctx}/quality/zjWttzd/wcqktbzlyComplete?"+value;
		}
	</script>
</head>
<body>
	...
	<form:form id="inputForm" modelAttribute="zjWttzd" action="${ctx}/quality/zjWttzd/saveWcqktbzly" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			...
			<c:if test="${identity == 'wcqktb' }">
			<input id="btnSubmit" class="btn btn-primary" type="button" onclick="tbwc();" value="填报完成"/>
			</c:if>
