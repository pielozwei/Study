...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/ip/task/form?id=${task.id}">滚动工作计划任务 修改</a></li>
		<li class="pull-right">
	...
	<form:form id="inputForm" modelAttribute="task" action="${ctx}/ip/task/save" method="post" class="form-horizontal">
	<form:hidden path="id"/>
		<form:hidden path="fbzt" value="${task.fbzt}"/>
		<input type="hidden" name="scollingJobPlanId" value="${scollingJobPlan.id}"/>
		<tags:message content="${message}"/>
	<!-- 任务项	 start -->
		<div class="control-group">
			<label class="control-label" for="gzrwmc">工作任务名称:</label>
			<div class="controls">
				<form:input path="gzrwmc" htmlEscape="false" maxlength="200"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="wcqx">完成期限:</label>
			<div class="controls">
				<form:input path="wcqx" htmlEscape="false" maxlength="200" />天
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="rwfzr">负责人:</label>
			<div class="controls">
				<form:input path="rwfzr.name" htmlEscape="false" maxlength="200"/>
                <%-- <tags:treeselect  id="rwfzr" disabled="true" name="rwfzr.id" value="${task.rwfzr.id}" labelName="rwfzr.name" labelValue="${task.rwfzr.name}"
					title="公司" url="/ip/scollingJobPlanTask/getAllMemberByWorkCenterId?scollingJobPlanId=${not empty scollingJobPlanId ? scollingJobPlanId : scollingJobPlan.id}"/> --%>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="rwxzr">协助人:</label>
			<div class="controls">
				<form:input path="rwxzr.name" htmlEscape="false" maxlength="200"/>
                <%-- <tags:treeselect disabled="true" id="rwxzr" name="rwxzr.id" value="${task.rwxzr.id}" labelName="rwxzr.name" labelValue="${task.rwxzr.name}"
					title="公司" url="/ip/scollingJobPlanTask/getAllMemberByWorkCenterId?scollingJobPlanId=${not empty scollingJobPlanId ? scollingJobPlanId : scollingJobPlan.id}"/> --%>
			</div>
		</div>
		<div class="control-group" id="rwfjwjDiv">
			...
			<div class="controls">
				<input type="hidden" id="rwfjwj" name="rwfjwj" value="${task.rwfjwj}" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="mbjyq" htmlEscape="false" rows="4" maxlength="500" class="input-xxlarge"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="jhkssj">计划开始时间:</label>
			<div class="controls">
				<input id="jhkssj" name="jhkssj" type="text" readonly="readonly" maxlength="20" class="input-small" value="<fmt:formatDate value="${task.jhkssj}" pattern="yyyy-MM-dd"/>" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="jhwcsj">计划完成时间:</label>
			<div class="controls">
				<input id="jhwcsj" name="jhwcsj" type="text" readonly="readonly" maxlength="20" class="input-small" value="<fmt:formatDate value="${task.jhwcsj}" pattern="yyyy-MM-dd"/>"/>
			</div>
		</div>
	<!-- 任务项	 end -->
	...
	<!-- 汇报项	 start -->
		<div class="control-group">
			...
			<div class="controls">
				<input id="sjkssj" name="sjkssj" type="text" readonly="readonly" maxlength="20" class="input-small Wdate" value="<fmt:formatDate value="${task.sjkssj}" pattern="yyyy-MM-dd"/>" 
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="sjwcsj" name="sjwcsj" type="text" readonly="readonly" maxlength="20" class="input-small Wdate" value="<fmt:formatDate value="${task.sjwcsj}" pattern="yyyy-MM-dd"/>"
					onclick="sjwcsjClick();" />
			</div>
		</div>
		...
		<div class="control-group" id="sfaqwcDiv">
			...
			<div class="controls">
				<form:select id="sfaqwc" path="sfaqwc">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="wcqksm" htmlEscape="false" rows="4" maxlength="100" class="input-xxlarge"/>
			</div>
		</div>
		<div class="control-group" id="jzcdDiv">
			<label class="control-label" for="jzcd">进展程度:</label>
			<div class="controls">
				<form:select id="jzcd" path="jzcd">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="jzqksm" htmlEscape="false" rows="4" maxlength="30" class="input-xxlarge"/>
			</div>
		</div>
	<!-- 汇报项	 end -->
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="bz" htmlEscape="false" rows="4" maxlength="500" class="input-xxlarge"/>
			</div>
		</div>
	...
	<!-- 取消项	 start -->
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="qxsj" name="qxsj" type="text" value="<fmt:formatDate value="${task.qxsj}" pattern="yyyy-MM-dd"/>" maxlength="200" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="qxr">取消人:</label>
			<div class="controls">
				<c:if test="${task.zxzt == 3}">
					<form:input id="qxr" path="updateBy.name" htmlEscape="false" maxlength="200"/>
				</c:if>
				<c:if test="${task.zxzt != 3}">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea id="qxyy" path="qxyy" htmlEscape="false" rows="4" maxlength="100" class="input-xxlarge"/>
			</div>
		</div>
	<!-- 取消项	 end -->	
