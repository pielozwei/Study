...
<head>
	...
	<script type="text/javascript">
		...
		function wtqr(){
			...
			window.location.href="${ctx}/quality/zjWttzd/wtqrcjfzrComplete?"+value;
		}
	</script>
</head>
<body>
	...
	<form:form id="inputForm" modelAttribute="zjWttzd" action="${ctx}/quality/zjWttzd/saveWtqrcjfzr" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			...
			<c:if test="${identity == 'wtqr' }">
			<input id="btnSubmit" class="btn btn-primary" type="button" onclick="wtqr();" value="问题确认"/>
			</c:if>
