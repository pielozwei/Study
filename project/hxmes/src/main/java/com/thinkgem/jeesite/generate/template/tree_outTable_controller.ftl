...
public class ${ClassName}Controller extends BaseController {
	...
	public String tree(Model model) {
		model.addAttribute("categoryList", ${className}Service.findAll${ClassName}());
	...
	public String list(${ClassName} ${className}, String id, HttpServletRequest request, HttpServletResponse response, Model model) {
		${className}.setId(id);
