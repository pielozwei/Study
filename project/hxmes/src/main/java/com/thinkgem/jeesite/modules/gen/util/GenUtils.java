...
//		}
	 ...
	 * @return
	 */
	public static Map<String, Object> getDataModel(GenScheme genScheme,String className,GenTable genTable_child){
		...
		if(genTable_child!=null){
			model.put("className_child", StringUtils.toCamelCase(genTable_child.getName()));
			model.put("ClassName_child", StringUtils.toCapitalizeCamelCase(genTable_child.getName()));
			String fk=genTable_child.getParentTableFk();
			model.put("parent_table_fk",fk);
			model.put("parentTableFk",StringUtils.toCamelCase(fk));
		}
